 ...
 * Field Arrays
 * Upload de arquivos
 * Composition Pattern - faltou explicação
 */
      ...
      <form
        ...
        <div className='flex flex-col gap-1'>
          ...
          {fields.map((field, index) => {
            return (
              <div className="flex gap-2 justify-between" key={field.id}>
                <input
                  type="text"
                  className='border border-zinc-200 shadow-sm rounded h-10 px-3  bg-zinc-800 text-white'
                ...
                <input
                  type="number"
                  className='w-28 border border-zinc-200 shadow-sm rounded h-10 px-3  bg-zinc-800 text-white'
